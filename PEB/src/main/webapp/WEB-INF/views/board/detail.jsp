<%@page import="bitedu.bipa.PEB.vo.BoardVO"%>
...
<h3>게시글 작성</h3>
<%
BoardVO temp = (BoardVO)request.getAttribute("board");
%>
<form action="./list.do" method="post" id="frm">
	...
	<table>
		...
		<tr><td>내용</td>
			<td><textarea cols="60" rows="5" name="content" id="content" readonly="readonly">${board.content}</textarea></td>
		<td></td></tr> <!-- textarea -->
